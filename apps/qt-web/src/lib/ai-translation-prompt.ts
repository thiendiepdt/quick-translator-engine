...
const modern: SettingModule = {
  ...
  terms: [
    ...
    "| 老大 (gọi người đứng đầu nhóm, băng, đội) | lão đại / sếp; người được gọi là nữ → lão đại hoặc chị đại | đại ca khi người được gọi là nữ |",
    "| 大哥 / 大姐 / 大佬 | anh, đại ca (nam) / chị, bà chị (nữ) / đại lão, trùm | đại ca cho nữ |",
    "",
    "Từ gọi người (老大, 老板, 头儿, 大哥, 老大哥…) phải theo **giới của người được gọi**: xác định giới qua glossary hoặc ngữ cảnh trước khi chọn từ; người được gọi là nữ thì không dùng `đại ca` / `anh` / `ông`. Chốt một dạng gọi cho mỗi nhân vật ngay lần đầu và dùng y hệt cả chương.",
    "",
    "### Tiếng lóng mạng",
    "",
    "| Raw | Dùng | KHÔNG dùng |",
