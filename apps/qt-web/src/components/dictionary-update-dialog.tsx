    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="w-[min(94vw,560px)]">
        <DialogHeader className="border-b px-6 py-5">
          ...
          <DialogDescription>
            {fixed
              ? "Entry được lưu trong trình duyệt và gửi dưới dạng patch ở mỗi request. Dictionary gốc trong engine không bị thay đổi."
              : "Entry được lưu trong trình duyệt, ghép vào dictionary draft và dùng ở lần dịch tiếp theo."}
          </DialogDescription>
        </DialogHeader>
