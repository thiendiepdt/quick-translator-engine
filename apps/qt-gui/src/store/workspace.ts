...
interface WorkspaceState {
  ...
  dictionaryDefaultsSource?: string;
  ...
  hydrateDictionaryDefaults: (source: string, defaults: DictionaryDefaults) => void;
...
export const useWorkspaceStore = create<WorkspaceState>()(persist((set) => ({
  ...
  dictionaryDefaultsSource: undefined,
  sourceView: "raw",
  outputView: "output",
  ...
  hydrateDictionaryDefaults: (source, defaults) =>
    set((state) => {
      if (state.dictionaryDefaultsSource === source) return state;
      ...
      return {
        dictionaries,
        dictionaryDefaultsSource: source,
      };
    }),
