  ...
  return (
    <div className={cn("flex h-full min-h-0 flex-col bg-card", mobile && "h-[calc(100dvh-5rem)]")}>
      <div className="shrink-0 border-b px-5 py-4">
        ...
        <p className="mt-2 text-xs leading-5 text-muted-foreground">
          {defaultsStatus === "ready"
            ? "Đã tải bản mặc định QT2025. Chấm xanh là file đã sửa và sẽ áp dụng cục bộ."
              ...
              return (
                ...
                >
                  ...
                  <span
                    ...
                    aria-label={draft.touched ? "Dùng bản đã sửa cục bộ" : "Dùng mặc định QT2025"}
                  />
                </button>
              );
            })}
      ...
      <div className="shrink-0 border-t bg-muted/35 px-5 py-3 text-[10px] leading-4 text-muted-foreground">
        ...
        <strong className="text-foreground/75">Base local:</strong> VietPhrase.txt và ChinesePhienAmWords.txt được nạp từ thư mục dữ liệu; cập nhật nhanh được phủ lên trong workspace.
      </div>
