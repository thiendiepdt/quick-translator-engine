    ...
    <div className="relative">
      ...
      >
        ...
        <PlateContent
          ...
          aria-multiline="true"
          className="plate-prompt-editor reading-font min-h-[420px] w-full rounded-md border bg-card px-8 py-7 text-[15px] text-card-foreground shadow-xs outline-none selection:bg-primary/15 focus-visible:ring-2 focus-visible:ring-ring/40"
