...
Các artifact này được giữ để tái tạo và kiểm chứng hành vi. Repository hiện không kèm văn
bản license xác nhận quyền phân phối lại cho toàn bộ các file đó. Việc một file có mặt
trong repository không có nghĩa file đó được cấp cùng license với phần code Rust.
...
- chọn và thêm license cho code Rust;
